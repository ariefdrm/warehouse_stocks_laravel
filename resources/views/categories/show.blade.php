<x-app-layout>
    ...
    <x-slot name="actions">
        ...
        <a href="{{ route('items.edit', $category->items->items_id) }}" class="flex items-center gap-2 px-4 py-2 text-sm font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-200">
