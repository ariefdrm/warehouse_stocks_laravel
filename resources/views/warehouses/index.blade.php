...
<x-app-layout>
    ...
    <x-slot name="actions">
        <a href="{{ route('warehouses.create') }}" class="flex items-center gap-2 px-4 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-xl hover:bg-slate-800 transition shadow-lg shadow-slate-200">
