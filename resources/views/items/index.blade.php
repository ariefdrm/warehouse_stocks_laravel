<x-app-layout>
    ...
    <x-slot name="actions">
        <a href="{{ route('items.create') }}" class="flex items-center gap-2 px-4 py-2.5 bg-blue-400 text-black dark:text-white text-sm font-bold rounded-xl hover:bg-blue-700 transition shadow-lg shadow-blue-200">
